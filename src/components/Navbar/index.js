  ...
  return (
    <header className="top-0 left-0 w-full h-24 px-5 box-border absolute  ">
      <nav className=" flex items-center justify-between sticky top-0 ">
        ...
        <ul
          className={`${menuopen? "right-[0] opacity-100  ": "right-[-282px]  opacity:0 hidenav sm:opacity-100 "} custom-css transiton-width  w-3/4 md:w-3/4 lg:w-3/5 flex-1 h-screen  absolute sm:static z-10 top-0  right-0  text-gray-200   sm:backdrop-filter-none   sm:h-16 flex flex-col sm:flex-row justify-center sm:p-5 xl:mt-6 md:mb-1 xl:mb-6 md:ml-28 xl:ml-96 mr-0  gap-2.5 sm:justify-between sm:text-center mainNav`}
        >
